...
export FZF_DEFAULT_OPTS='--no-height --no-reverse --bind "€:execute-silent(notify-send {}),alt-n:preview-down,alt-p:preview-up,alt-j:preview-down,alt-k:preview-up,ctrl-f:preview-page-down,ctrl-b:preview-page-up,ctrl-q:abort"'
